...
<body>
    ...
    <section>
        ...
        <div class="info">
            ...
            ?>
            <form action="add_products_db.php" method="post" class="adduser" enctype="multipart/form-data">
                <input type="text" name="product_name" placeholder="ใส่ชื่อสินค้า" required>
                <br>
                <input type="text" name="product_price" placeholder="ใส่ราคาสินค้า" required>
                <br>
                <input type="text" name="product_qty" placeholder="ใส่จำนวนสินค้า" required>
                <br>
                <p>ประเภทสินค้า</p>
                ...
                <br>
                <textarea name="product_detail" placeholder="ใส่รายละเอียดสินค้า" required></textarea>
                <br>
