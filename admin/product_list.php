...
<body>
    ...
    <section>
        ...
        <div class="info">
            <a href="add_products.php" style="padding: .5rem; background: green; display: inline-block; color:#fff; text-decoration: none;">เพิ่มสินค้า</a>
            <?php
            ...
            <table width="100%">
                ...
                <tr>
                    ...
                    <td><img width="50%" src="../img/<?php echo $row['pic']; ?>"></td>
                    <td><?php echo $row['product_name'] ?></td>
                    <td><?php echo $row['price'] ?></td>
                    <td><?php echo $row['product_qty'] ?></td>
                    <td><?php echo $row['type_name'] ?></td>
                    <td><a href="edit_products.php?edit=<?php echo $row['product_id']; ?>">แก้ไข</a></td>
                    <td><a href="delete_products.php?delete=<?php echo $row['product_id']; ?>" onclick="return confirm('คุณต้องการลบสินค้าใช่ไหม');">ลบ</a></td>
                </tr>
                <?php } ?>
            </table>
